...
[t,y] = ode23s(@semi_batch_reactor, tspan, [cA_0 cP_0 cC_0 T0 Vin]);
...
Conversion = (ntot-cA(end)*V(end))/ntot;
Selectivity = cP(end)*V(end)/(ntot-cA(end)*V(end));
